**DY-73 Dice Roller** is a console application that contains multiple games of chance played against the computer.
...
### SELECT GAME MENU
SelectGame generates an arrow-key driven menu in the console.
...
### HIGH DIE GAME
Selecting High Die in the SelectGame menu calls the RunHighDieGame method from the HighDieGame class.
...
### DOUBLES GAME
Selecting Doubles in the SelectGame menu calls the RunDoublesGame method from the DoublesGame class.
...
## BEST OF FIVE GAME
Selecting Best of Five in the SelectGame menu calls the RunBestOfFiveGame method from the BestOfFiveGame class.
